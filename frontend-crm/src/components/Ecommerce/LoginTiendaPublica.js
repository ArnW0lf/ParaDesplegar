...
export default function LoginTiendaPublica() {
  ...
  try {
    ...
    // Guardamos el estado de login por tienda
    localStorage.setItem(`token_${slug}`, JSON.stringify({
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        <h1 className="text-2xl font-bold text-center text-blue-600 mb-4">{storeName}</h1>
